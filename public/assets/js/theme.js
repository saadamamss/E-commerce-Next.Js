...
function pureFadeOut(e) {
  ...
  o.style.opacity = 1;
  (function e() {
    if ((o.style.opacity -= 0.02) < 0) o.style.display = "none";
...
(function () {
  ...
  UomoElements.StickyElement = (function () {
    ...
    StickyElement.prototype = Object.assign({}, StickyElement.prototype, {
      _init: function () {
        ...
        //window.addEventListener("scrollend", this._updateStatus);
      },
      _updateStatus() {
        const _this = this;
  ...
  UomoSections.CustomerSideForm = (function () {
    function CustomerSideForm() {
      ...
      if (this.$formsWrapper) this._showLoginForm();
      if (this.$formsWrapper) this._showRegisterForm();
    }
        ...
        this.$aside
          ...
          .forEach((el) => {
            el.addEventListener("click", (event) => {
              ...
              if ($divider)
                if ($divider?.classList.contains("cart-drawer-divider"))
    ...
    SwiperSlideshow.prototype = Object.assign({}, SwiperSlideshow.prototype, {
      _initSliders() {
        this.$containers.forEach(function ($sliderContainer) {
          ...
          if (
            $sliderContainer?.classList.contains("swiper-number-pagination")
          ) {
          ...
          if ($sliderContainer.querySelectorAll(".swiper-slide").length > 1) {
            ...
            if ($active_slide)
              $active_slide?.classList.add("swiper-slide-active");
          }
        });
      },
    });
...
window.onload = () => {
  setTimeout(() => {
    const $containers = document.querySelectorAll(".js-swiper-slider");
    ...
    function _initSliders() {
      $containers.forEach(function ($sliderContainer) {
        ...
        if ($sliderContainer.querySelectorAll(".swiper-slide").length > 1) {
          ...
          if ($active_slide) $active_slide?.classList.add("swiper-slide-active");
        }
      });
    }
