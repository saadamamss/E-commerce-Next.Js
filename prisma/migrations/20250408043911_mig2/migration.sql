/*
  ...
  - You are about to drop the column `shopId` on the `reviews` table. All the data in the column will be lost.
...
-- DropIndex
DROP INDEX `reviews_shopId_fkey` ON `reviews`;

-- AlterTable
ALTER TABLE `reviews` DROP COLUMN `shopId`;
